                  ...
                  >
                    ...
                    <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                      <div className="flex items-center w-full md:w-auto justify-between">
                        ...
                        <Link href="/">
                          <a className="flex justify-start font-bold text-indigo-600 hover:text-indigo-500 text-2xl">Dagline Moving</a>
                        </Link>
                    ...
                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                      <div className="px-5 pt-4 flex items-center justify-between">
                        <div>
                          ...
                          <Link href='/'>
                            <span className="flex justify-start font-bold text-indigo-600 hover:text-indigo-500 text-2xl">Dagline Moving</span>
                          </Link>
